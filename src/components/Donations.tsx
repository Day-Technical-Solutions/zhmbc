                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Tabs
                          value={field.value}
                          onValueChange={(v) =>
                            field.onChange(v as DonationForm["paymentMethod"])
                          }
                          ...
                          <TabsContent value="card" className="pt-4 space-y-3">
                            {!amount || amount <= 0 ? (
                              <p className="text-sm text-gray-600">
                                Enter a donation amount to load the secure card
                                field.
                              </p>
                            ) : loadingPI ? (
                              <p className="text-sm text-gray-600">
                              ...
                              <Elements
                                ...
                                key={
                                  clientSecret /* force remount when intent changes */
                                }
                              >
                                <StripeCardSection
                                  onSuccess={() =>
                              ...
                              <p className="text-sm text-red-600">
                                We couldn’t initialize payment. Please adjust
                                the amount or try again.
                              </p>
                            )}
                          </TabsContent>
