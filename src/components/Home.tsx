...
import { Clock, Calendar, MapPin, Heart, Mail, Phone } from "lucide-react";
import placeholder from "/src/images/placeholder.svg";
import HeroPhoto from "/images/church_front_panoramic.jpg";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Our youth group meets every Friday at 6:30 PM for fellowship and
                fun.
              </p>
            </div>
          </div>
