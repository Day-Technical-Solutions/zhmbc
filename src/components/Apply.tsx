				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto text-center mb-12">
						...
						<p className="text-lg text-muted-foreground mb-4">
							The position of Senior Pastor at Zion Hope Missionary Baptist Church is a sacred
							responsibility that requires spiritual maturity, theological depth, and a proven track
							record of faithful ministry. We seek a shepherd who will lead our congregation with
						...
						<p className="text-lg text-muted-foreground">
							...
							mail or email. This allows our pastoral search committee to give each application the
							careful, prayerful consideration it deserves.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
						<Card className="text-center">
							...
							<CardContent>
								<CardDescription className="text-base">
									Master of Divinity or equivalent from an accredited seminary is preferable.
								</CardDescription>
							</CardContent>
						</Card>
						...
						<Card className="text-center">
							...
							<CardContent>
								<CardDescription className="text-base">
									Minimum of 5 years in pastoral ministry or in a senior leadership role.
								</CardDescription>
							</CardContent>
						</Card>
						...
						<Card className="text-center">
							...
							<CardContent>
								<CardDescription className="text-base">
									Must be a lisenced and ordained minister in the body of Christ.
								</CardDescription>
							</CardContent>
						</Card>
					</div>
						...
						<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
							{[
								...
								},
								{
									...
									desc: "Detailed CV or resume of ministry experience",
								},
								{
									title: "Ordination Certificate",
									desc: "Copy of your ordination documentation",
								},
								{
								...
								},
								{
									...
									desc: "6 Letters from ministry references",
								},
							].map((doc, index) => (
