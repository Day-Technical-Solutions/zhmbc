            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="border-2 border-indigo-200">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-base">
                    Download, print, and complete the official Senior Pastoral
                    Application form.
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-base">
                    The vacancy announcement packet contains the following
                    sections:
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mb-12">
              Please include the following documents with your completed
              application:
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "5 Letters from ministry references",
                },
              ].map((doc, index) => (
