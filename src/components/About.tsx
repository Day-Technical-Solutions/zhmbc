			...
			<section className="relative h-[300px]">
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="text-center text-white max-w-4xl px-4">
						...
						<p className="text-xl md:text-2xl">Serving God and our community since 1965</p>
					</div>
				</div>
			</section>
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<div className="space-y-4 text-gray-600">
								<p>
									Founded in 1965 by Rev. Dr. James Wilson, Zion Hope Missionary Baptist Church
									began as a small gathering of faithful believers in Miami, Florida. Through God's
									grace and the dedication of its members, our church has grown into a vibrant
									community of faith.
								</p>
								<p>
									Over the decades, we have established numerous ministries, built our current
									sanctuary, and continue to expand our outreach programs. Under the current
									leadership of Rev. Michael Thompson, we remain committed to our founding
									principles while adapting to serve our community's evolving needs.
								</p>
								<p>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-3xl mx-auto text-center">
						...
						<div className="inline-block bg-white px-6 py-4 rounded-lg shadow-md">
							<p className="font-semibold text-gray-800">Sunday Service: 10:00 AM</p>
