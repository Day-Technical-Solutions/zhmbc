...
import FounderPhoto from "/images/freeman.jpg";
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl px-4">
            ...
            <p className="text-xl md:text-2xl">
              Serving God and our community since 1958
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 1958 by Rev. Paul Freeman and company, Zion Hope
                  Missionary Baptist Church began as a small gathering of
                  faithful believers in Miami, Florida. Through God's grace and
                  the dedication of its members, our church has grown into a
                ...
                <p>
                  ...
                  outreach programs. As we search for leadership, we remain
                  committed to our founding principles while adapting to serve
