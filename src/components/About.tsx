...
import HeroPhoto from "/images/church_corner.jpg";
import FounderPhoto from "/images/church_sidewalk.jpg";
			...
			<section className="relative h-[450px]">
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="text-center text-white max-w-4xl px-4">
						...
						<p className="text-xl md:text-2xl">Serving God and our community since 1958</p>
					</div>
				</div>
			</section>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-xl text-gray-600 leading-relaxed">
							To spread the love of Christ through worship, discipleship, and service, while
							building a community of believers who are deeply rooted in faith and actively engaged
							in transforming lives through the power of the Gospel.
						</p>
					</div>
				</div>
			</section>
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<div className="space-y-4 text-gray-600">
								<p>
									Founded in 1958 by Rev. Paul Freeman and company, Zion Hope Missionary Baptist
									Church began as a small gathering of faithful believers in Miami, Florida. Through
									God's grace and the dedication of its members, our church has grown into a vibrant
									community of faith.
								</p>
								<p>
									Over the decades, we have established numerous ministries, built our current
									sanctuary, and continue to expand our outreach programs. As we search for
									leadership, we remain committed to our founding principles while adapting to serve
									our community's evolving needs.
								</p>
								<p>
									Today, ZHMBC stands as a beacon of hope in our community, continuing our legacy of
									faith, fellowship, and service to God's people.
								</p>
							</div>
						</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-gray-600 mb-8">
							We welcome you to join us for worship and fellowship. Experience the warmth of our
							church family and the power of God's word in your life.
						</p>
						<div className="inline-block bg-white px-6 py-4 rounded-lg shadow-md">
							<p className="font-semibold text-gray-800">Sunday Service: 9:15 AM</p>
