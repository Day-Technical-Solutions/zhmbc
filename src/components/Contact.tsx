			...
			<section className="relative h-[450px]">
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="text-center text-white">
						...
						<p className="text-xl md:text-2xl">Get in touch with our church family</p>
					</div>
				</div>
			</section>
							...
							<div className="space-y-6">
								...
								<div className="flex items-start space-x-4">
									...
									<div>
										...
										<p className="text-gray-600">(786)-703-5278</p>
									</div>
								</div>
									...
									<form onSubmit={handleSubmit}>
										<div className="space-y-4">
											...
											<div>
												...
												{errors.subject && (
													<p className="text-sm text-red-500 mt-1">{errors.subject[0]}</p>
												)}
											</div>
											<div>
												...
												{errors.message && (
													<p className="text-sm text-red-500 mt-1">{errors.message[0]}</p>
												)}
											</div>
										</div>
