			...
			<section className="relative h-[300px]">
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="text-center text-white">
						...
						<p className="text-xl md:text-2xl">Share your prayer needs with our church family</p>
					</div>
				</div>
			</section>
					...
					<div className="max-w-2xl mx-auto">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Your prayer request will be shared with our prayer team who will lift your needs
									in prayer.
								</CardDescription>
							</CardHeader>
							<CardContent>
								<form onSubmit={handleSubmit}>
									<div className="space-y-6">
										...
										<div>
											...
											{errors.requestType && (
												<p className="text-sm text-red-500 mt-1">{errors.requestType[0]}</p>
											)}
										</div>
										...
										<div>
											...
											/>
											{errors.request && (
												<p className="text-sm text-red-500 mt-1">{errors.request[0]}</p>
											)}
										</div>
										...
										<div className="space-y-4">
											<div className="flex items-center space-x-2">
												...
												<Label htmlFor="urgent">This is an urgent request</Label>
											</div>
							...
							{success && (
								<CardFooter>
									<div className="flex items-center text-green-600 w-full bg-green-50 p-3 rounded-lg">
										...
										Prayer request submitted successfully. Our prayer team will be praying for you.
									</div>
								</CardFooter>
							)}
						</Card>
						...
						<div className="mt-8 bg-gray-50 rounded-lg p-6">
							<h3 className="text-lg font-semibold mb-4">About Our Prayer Ministry</h3>
							<p className="text-gray-600 mb-4">
								Our dedicated prayer team commits to praying for each request received. We believe
								in the power of prayer and stand together with you in faith.
							</p>
							<p className="text-gray-600">
								For immediate prayer needs or to speak with a pastor, please call our prayer line at
								(305) 555-0123.
							</p>
						</div>
					</div>
