        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl md:text-2xl">
              Meet the people who make our ministry possible
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              We welcome all who wish to join our congregation and serve in our
              various ministries. Whether you're looking to become a member or
              interested in serving in a specific ministry, we'd love to connect
              with you.
            </p>
            <Button
