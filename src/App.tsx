                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white">
                      <h1 className="text-4xl md:text-6xl font-bold mb-4">
                        Welcome to Zion Hope Missionary Baptist Church
                      </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                      <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600">
                          Join us every Sunday at 10:00 AM for our main worship
                          service.
                        </p>
                      </div>
                      <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600">
                          Dive deeper into God's word every Wednesday at 7:00
                          PM.
                        </p>
                      </div>
                      <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600">
                          Our youth group meets every Friday at 6:30 PM for
                          fellowship and fun.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                      ...
                      <div className="border rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <p className="text-gray-600 mb-4">
                            An evening of praise and worship music.
                          </p>
                          <div className="flex items-center text-gray-500 mb-2">
                            <Calendar className="h-5 w-5 mr-2" />
                          ...
                          <div className="flex items-center text-gray-500">
                            <MapPin className="h-5 w-5 mr-2" />
                            <span>
                              Zion Hope Missionary Baptist Church Auditorium
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <section id="members" className="py-16 bg-gray-100">
                  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-center text-gray-600 mb-8">
                      Meet some of our dedicated members who serve in various
                      ministries.
                    </p>
                  ...
                  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                      <p className="text-gray-600 mb-8">
                        Your generous donations help us continue our mission and
                        serve our community. Every contribution, no matter the
                        size, makes a difference in the lives we touch.
                      </p>
                      ...
                      <p className="text-sm text-gray-500">
                        For other ways to give or for any questions about
